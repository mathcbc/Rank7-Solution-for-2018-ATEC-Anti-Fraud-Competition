--‘上一次’的数据特征提取
drop table if EXISTS atec_test_data_feature_1;
create table atec_test_data_feature_1
as select
...
from atec_test_series;
-- 判断此次交易和上一次交易是否相同
drop table if EXISTS atec_test_data_feature_2;
create table atec_test_data_feature_2
as select event_id,
